...
//-------------------------------------------------------------------------------------------------------------
    ...
    public ArrayList<AddElevator> getAddElevator() {
        return this.add_elevator;
    }
    public ArrayList<RequestPercentage> getRequestPercentage() {
        return this.request_percentage;
    }
    public ArrayList<PassengerRequestPercentage> getPassengerRequestPercentage() {
        return this.passenger_request_percentage;
    }
