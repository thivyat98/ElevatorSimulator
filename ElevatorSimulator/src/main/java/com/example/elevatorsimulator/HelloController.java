...
protected void onHelloButtonClick(ActionEvent event) {
    ...
    elevatorSimSceneController.setAddElevator(Hellosm.getAddElevator());
    elevatorSimSceneController.setRequestPercentage(Hellosm.getRequestPercentage());
    elevatorSimSceneController.setPassengerRequestPercentage(Hellosm.getPassengerRequestPercentage());
